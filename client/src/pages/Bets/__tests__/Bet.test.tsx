...
const mockBetReturnValue: MockReactQueryReturnValueType = {
  data: BETTING_PRODUCT_MOCK,
};
let mockBetLoadingState = false;

const mockGameReturnValue: MockReactQueryReturnValueType = {
  data: GAME_INFO_MOCK,
};
jest.resetAllMocks();
...
describe("test BetDetails component", () => {
  it("renders the track name", () => {
    ...
    const raceName = within(table).getByRole("cell", {
